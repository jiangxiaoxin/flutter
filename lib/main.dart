...
import 'package:flutter_app/sliver/test2.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<DropdownMenuItem<String>> getDropdownItems() {
    return ['1', '2', '3', '4'].map<DropdownMenuItem<String>>((String value) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          decoration: BoxDecoration(color: Color.fromRGBO(22, 30, 78, 1.0)),
          child: ListView(
            children: [
              Image.network(
